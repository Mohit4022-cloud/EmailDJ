...
- Generated at: `2026-05-07T17:37:49.296940Z`
...
|---|---|---|---|
| `hub_api_full_suite` | `pass` | `backend_green=green`<br>`backend_suite_summary=396 passed in 13.59s` | `none` |
...
| `lock_and_launch_artifacts` | `pass` | `harness_green=green`<br>`render_blueprint_green=green`<br>`provider_stub_cases=96/96`<br>`launch_report_generated_at=2026-05-07T17:37:49.248801Z` | `none` |
...
| `release_fingerprint_parity` | `blocked` | `release_fingerprint_available=True`<br>`release_fingerprint=git_sha=36445e4c4bf5`<br>`runtime_source_used=local_env` | `release_fingerprint_unavailable` |
