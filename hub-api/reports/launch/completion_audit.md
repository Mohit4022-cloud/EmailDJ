...
- Generated at: `2026-05-07T22:06:07.441695Z`
- Current git SHA: `d07a121392cc664feacb598120338463a7bb9d65`
...
| `deployed_http_smoke` | `blocked` | `required_http_smoke_routes=['generate', 'remix']`<br>`route_gates={'generate': True, 'remix': True, 'preview': False}`<br>`localhost_smoke_provider_source_counts={'provider_stub': 60}`<br>`current_git_sha=d07a121392cc664feacb598120338463a7bb9d65`<br>`web_app_probe_workspace_git_sha=d07a121392cc664feacb598120338463a7bb9d65`<br>`web_app_probe_source_git_sha=d07a121392cc664feacb598120338463a7bb9d65`<br>`web_app_client_bundle_usable=False`<br>`web_app_probe_failures=['http_error:401', 'web_app_deployment_requires_auth', 'web_app_deployment_requires_auth_or_vercel_protection_bypass', 'no_same_origin_bundle_assets_found', 'vite_hub_url_not_found_in_bundle', 'vite_preview_pipeline_not_found_in_bundle']` | `http_smoke_external_provider_missing_for_launch_mode:limited_rollout`<br>`web_app_deployment_probe_not_usable`<br>`web_app_deployment_probe:http_error:401`<br>`web_app_deployment_probe:web_app_deployment_requires_auth`<br>`web_app_deployment_probe:web_app_deployment_requires_auth_or_vercel_protection_bypass`<br>`web_app_deployment_probe:no_same_origin_bundle_assets_found`<br>`web_app_deployment_probe:vite_hub_url_not_found_in_bundle` |
