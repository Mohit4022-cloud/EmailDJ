...
- Generated at: `2026-05-08T13:31:23.156415Z`
- Current git SHA: `afb3c05736a56f48ca8a5682953a4c7f0733a715`
...
|---|---|---|---|
| `hub_api_full_suite` | `pass` | `backend_green=green`<br>`backend_suite_summary=431 passed, 1 warning in 14.11s` | `none` |
...
| `lock_and_launch_artifacts` | `pass` | `harness_green=green`<br>`render_blueprint_green=green`<br>`provider_stub_cases=96/96`<br>`launch_report_generated_at=2026-05-08T13:31:19.679182Z` | `none` |
| `deployed_preflight_inputs` | `blocked` | `preflight_ready=False`<br>`required_inputs_present={'STAGING_BASE_URL': False, 'PROD_BASE_URL': False, 'BETA_KEY': True, 'OPENAI_API_KEY': True, 'VERCEL_AUTOMATION_BYPASS_SECRET': False}`<br>`failure_bucket=operator_input_missing` | `STAGING_BASE_URL`<br>`PROD_BASE_URL`<br>`VERCEL_AUTOMATION_BYPASS_SECRET` |
...
| `deployed_http_smoke` | `blocked` | `required_http_smoke_routes=['generate', 'remix']`<br>`route_gates={'generate': True, 'remix': True, 'preview': False}`<br>`localhost_smoke_provider_source_counts={'provider_stub': 60}`<br>`current_git_sha=afb3c05736a56f48ca8a5682953a4c7f0733a715`<br>`web_app_probe_workspace_git_sha=afb3c05736a56f48ca8a5682953a4c7f0733a715`<br>`web_app_probe_source_git_sha=afb3c05736a56f48ca8a5682953a4c7f0733a715`<br>`web_app_client_bundle_usable=False`<br>`web_app_probe_failures=['http_error:401', 'web_app_deployment_requires_auth', 'web_app_deployment_requires_auth_or_vercel_protection_bypass', 'vercel_protection_bypass_secret_missing', 'no_same_origin_bundle_assets_found', 'vite_hub_url_not_found_in_bundle', 'vite_preview_pipeline_not_found_in_bundle']` | `http_smoke_external_provider_missing_for_launch_mode:limited_rollout`<br>`web_app_deployment_probe_not_usable`<br>`web_app_deployment_probe:http_error:401`<br>`web_app_deployment_probe:web_app_deployment_requires_auth`<br>`web_app_deployment_probe:web_app_deployment_requires_auth_or_vercel_protection_bypass`<br>`web_app_deployment_probe:vercel_protection_bypass_secret_missing`<br>`web_app_deployment_probe:no_same_origin_bundle_assets_found` |
| `release_fingerprint_parity` | `blocked` | `release_fingerprint_available=True`<br>`release_fingerprint=git_sha=afb3c05736a5`<br>`runtime_source_used=local_env`<br>`comparison_fields=[]` | `release_fingerprint_parity_not_from_production_runtime_snapshot:local_env`<br>`release_fingerprint_comparison_fields_missing` |
