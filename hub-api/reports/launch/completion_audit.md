...
- Generated at: `2026-05-08T13:41:40.847606Z`
- Current git SHA: `e779b5b31ade28d429673756f225a54673319afc`
...
|---|---|---|---|
| `hub_api_full_suite` | `pass` | `backend_green=green`<br>`backend_suite_summary=436 passed, 1 warning in 14.78s` | `none` |
...
| `lock_and_launch_artifacts` | `pass` | `harness_green=green`<br>`render_blueprint_green=green`<br>`provider_stub_cases=96/96`<br>`launch_report_generated_at=2026-05-08T13:41:36.350052Z` | `none` |
...
| `deployed_http_smoke` | `blocked` | `required_http_smoke_routes=['generate', 'remix']`<br>`route_gates={'generate': True, 'remix': True, 'preview': False}`<br>`localhost_smoke_provider_source_counts={'provider_stub': 60}`<br>`current_git_sha=e779b5b31ade28d429673756f225a54673319afc`<br>`web_app_probe_workspace_git_sha=e779b5b31ade28d429673756f225a54673319afc`<br>`web_app_probe_source_git_sha=e779b5b31ade28d429673756f225a54673319afc`<br>`web_app_client_bundle_usable=False`<br>`web_app_probe_failures=['http_error:401', 'web_app_deployment_requires_auth', 'web_app_deployment_requires_auth_or_vercel_protection_bypass', 'vercel_protection_bypass_secret_missing', 'no_same_origin_bundle_assets_found', 'vite_hub_url_not_found_in_bundle', 'vite_preview_pipeline_not_found_in_bundle']` | `http_smoke_external_provider_missing_for_launch_mode:limited_rollout`<br>`web_app_deployment_probe_not_usable`<br>`web_app_deployment_probe:http_error:401`<br>`web_app_deployment_probe:web_app_deployment_requires_auth`<br>`web_app_deployment_probe:web_app_deployment_requires_auth_or_vercel_protection_bypass`<br>`web_app_deployment_probe:vercel_protection_bypass_secret_missing`<br>`web_app_deployment_probe:no_same_origin_bundle_assets_found` |
| `release_fingerprint_parity` | `blocked` | `release_fingerprint_available=True`<br>`release_fingerprint=git_sha=e779b5b31ade`<br>`runtime_source_used=local_env`<br>`comparison_fields=[]` | `release_fingerprint_parity_not_from_production_runtime_snapshot:local_env`<br>`release_fingerprint_comparison_fields_missing` |
