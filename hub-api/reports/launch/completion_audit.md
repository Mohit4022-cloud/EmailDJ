...
|---|---|---|---|
| `hub_api_full_suite` | `pass` | `backend_green=green`<br>`backend_suite_summary=389 passed, 1 warning in 12.61s` | `none` |
...
| `lock_and_launch_artifacts` | `pass` | `harness_green=green`<br>`render_blueprint_green=green`<br>`provider_stub_cases=96/96`<br>`launch_report_generated_at=2026-05-07T16:11:36.891849Z` | `none` |
...
| `release_fingerprint_parity` | `blocked` | `release_fingerprint_available=True`<br>`release_fingerprint=git_sha=a17657a02bd1`<br>`runtime_source_used=local_env` | `release_fingerprint_unavailable` |
