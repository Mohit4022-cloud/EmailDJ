...
- Generated at: `2026-05-08T01:40:04.456156Z`
- Current git SHA: `fa77cf1be06a47fdc11c6db0b0e1b1156bd25357`
...
| `deployed_http_smoke` | `blocked` | `required_http_smoke_routes=['generate', 'remix']`<br>`route_gates={'generate': True, 'remix': True, 'preview': False}`<br>`localhost_smoke_provider_source_counts={'provider_stub': 60}`<br>`current_git_sha=fa77cf1be06a47fdc11c6db0b0e1b1156bd25357`<br>`web_app_probe_workspace_git_sha=fa77cf1be06a47fdc11c6db0b0e1b1156bd25357`<br>`web_app_probe_source_git_sha=fa77cf1be06a47fdc11c6db0b0e1b1156bd25357`<br>`web_app_client_bundle_usable=False`<br>`web_app_probe_failures=['http_error:401', 'web_app_deployment_requires_auth', 'web_app_deployment_requires_auth_or_vercel_protection_bypass', 'vercel_protection_bypass_secret_missing', 'no_same_origin_bundle_assets_found', 'vite_hub_url_not_found_in_bundle', 'vite_preview_pipeline_not_found_in_bundle']` | `http_smoke_external_provider_missing_for_launch_mode:limited_rollout`<br>`web_app_deployment_probe_not_usable`<br>`web_app_deployment_probe:http_error:401`<br>`web_app_deployment_probe:web_app_deployment_requires_auth`<br>`web_app_deployment_probe:web_app_deployment_requires_auth_or_vercel_protection_bypass`<br>`web_app_deployment_probe:vercel_protection_bypass_secret_missing`<br>`web_app_deployment_probe:no_same_origin_bundle_assets_found` |
