...
- Generated at: `2026-05-08T13:10:55.088491Z`
...
- `backend` path=`/Users/mohit/EmailDJ/hub-api/reports/launch/backend_suite.json` timestamp=`2026-05-08T12:54:38.359773Z` age_hours=`0.27` stale=`False` malformed=`False` schema_incomplete=`False` missing=`False`
- `provider_stub_harness` path=`/Users/mohit/EmailDJ/hub-api/reports/provider_stub/latest.json` timestamp=`2026-05-07T17:37:47.865226Z` age_hours=`19.55` stale=`False` malformed=`False` schema_incomplete=`False` missing=`False`
- `external_provider_harness` path=`/Users/mohit/EmailDJ/hub-api/reports/external_provider/latest.json` timestamp=`2026-05-07T14:26:09.024582Z` age_hours=`22.75` stale=`False` malformed=`False` schema_incomplete=`False` missing=`False`
- `provider_shim_capture` path=`/Users/mohit/EmailDJ/hub-api/debug_runs/launch_ops/provider_shim/20260507T033814Z/summary.json` timestamp=`2026-05-07T03:38:14.704193Z` age_hours=`33.54` stale=`False` malformed=`False` schema_incomplete=`False` missing=`False`
- `external_provider_capture` path=`/Users/mohit/EmailDJ/hub-api/debug_runs/launch_ops/external_provider/20260507T123230Z/summary.json` timestamp=`2026-05-07T12:33:10.589611Z` age_hours=`24.63` stale=`False` malformed=`False` schema_incomplete=`False` missing=`False`
- `localhost_smoke` path=`/Users/mohit/EmailDJ/hub-api/debug_runs/smoke/manual/summary.json` timestamp=`2026-05-07T14:29:59.727772Z` age_hours=`22.68` stale=`False` malformed=`False` schema_incomplete=`False` missing=`False`
...
- `deployment_discovery` path=`/Users/mohit/EmailDJ/hub-api/reports/launch/deployment_discovery.json` timestamp=`2026-05-08T13:10:38.267156Z` age_hours=`0.0` stale=`False` malformed=`False` schema_incomplete=`False` missing=`False`
...
- `checked_at`: `2026-05-08T13:10:55.024514Z`
- `exit_code`: `0`
...
- Review discovered candidate `https://email-8dcxxpakj-mohits-projects-e629a988.vercel.app` first; then set `WEB_APP_ORIGIN` to the deployed web-app origin for the target launch environment, then re-capture staging and production runtime snapshots.
