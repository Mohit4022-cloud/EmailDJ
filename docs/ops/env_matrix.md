...
| BETA_KEY | no | - | 1 | hub-api/scripts/launch_preflight.py |
...
| BUILD_ID | no | - | 1 | hub-api/runtime_debug.py |
...
| EMAILDJ_BUILD_ID | no | - | 1 | hub-api/runtime_debug.py |
...
| EMAILDJ_GIT_SHA | no | - | 2 | hub-api/runtime_debug.py, hub-api/tests/integration/test_web_mvp_api.py |
| EMAILDJ_IMAGE_TAG | no | - | 1 | hub-api/runtime_debug.py |
...
| EMAILDJ_RELEASE_VERSION | no | - | 1 | hub-api/runtime_debug.py |
...
| GITHUB_SHA | no | - | 2 | hub-api/evals/runner.py, hub-api/runtime_debug.py |
| GROQ_API_KEY | yes | gsk_...                # Required when EMAILDJ_REAL_PROVI... | 1 | hub-api/email_generation/quick_generate.py |
| IMAGE_TAG | no | - | 1 | hub-api/runtime_debug.py |
...
| PINECONE_API_KEY | yes | pcsk_... | 1 | hub-api/runtime_debug.py |
| PINECONE_ENVIRONMENT | yes | us-east-1 | 0 | - |
| PINECONE_INDEX_NAME | yes | emaildj-contexts | 1 | hub-api/runtime_debug.py |
| PROD_BASE_URL | no | - | 1 | hub-api/scripts/launch_preflight.py |
...
| RENDER_GIT_COMMIT | no | - | 1 | hub-api/runtime_debug.py |
