...
- `make launch-verify-deployed` is the deployed-service gate: preflight, staging and production runtime snapshots, real-provider smoke, staging Hub API HTTP smoke, then launch check.
