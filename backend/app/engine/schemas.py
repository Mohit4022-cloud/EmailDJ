    ...
    "properties": {
        ...
        "brief_quality": {
            ...
            "required": [
                ...
                "has_research",
                "grounded_fact_count",
                "prospect_context_fact_count",
                "seller_context_fact_count",
                "seller_proof_fact_count",
                "cta_fact_count",
                "confidence_ceiling",
                "signal_strength",
                "overreach_risk",
            ...
            "properties": {
                ...
                "grounded_fact_count": {"type": "integer", "minimum": 0, "maximum": 500},
                "prospect_context_fact_count": {"type": "integer", "minimum": 0, "maximum": 500},
                "seller_context_fact_count": {"type": "integer", "minimum": 0, "maximum": 500},
                "seller_proof_fact_count": {"type": "integer", "minimum": 0, "maximum": 500},
                "cta_fact_count": {"type": "integer", "minimum": 0, "maximum": 500},
                "confidence_ceiling": {"type": "number", "minimum": 0.0, "maximum": 1.0},
                "signal_strength": {"type": "string", "enum": ["low", "medium", "high"]},
                "overreach_risk": {"$ref": "#/$defs/OverreachRisk"},
